...
$(".next").click(function () {
    ...
    if (firstInputValue === '') {
		 document.querySelector('#first_input_error').style.visibility="visible";
    }
    if (secondInputValue === '') {
		document.querySelector('#second_input_error').style.visibility="visible";
    }
    if (monthInputValue === '' || dayInputValue === '' ||  yearInputValue === '') {
        document.querySelector('#dateofbirth_input_error').style.visibility="visible";
    }
